        ...
        <div className="bg-projects1 flex flex-col justify-center items-center">
            <div className="flex flex-col">
                ...
                <div className="mt-[20px]">
                    <Image
                        src={"/assets/images/projects/FoodOrdering_MobApp.png"}
                        width={width}
                        height={300}
                ...
                <div className="mt-[80px]">
                    ...
                    >
                        A responsive food ordering system app that streamline
                        various aspects of a food business. This is designed to
                        cater the needs of food business owners, employees and
                        franchisees. It combines several essential features
                        including employees attendance system, food and stock
                        ordering, a franchise management system and view
                        analytics for data needed.
                    </div>
                    {/*Mobile*/}
                    ...
                    <div className="mt-[30px]">
                        ...
                        <div className="mt-[30px]">
                            <Image
                                src={
                                    "/assets/images/projects/FoodOrdering_MobApp (3).png"
                                }
                                width={width}
                                height={300}
                                className="rounded-[10px]"
                        ...
                        <div className="mt-[50px]">
                            <Image
                                src={
                                    "/assets/images/projects/FoodOrdering_MobApp (4).png"
                                }
                                width={width}
                                height={300}
                                className="rounded-[10px]"
