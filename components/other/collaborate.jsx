...
function collaborate() {
    return (
        ...
        >
            <div className="flex flex-row gap-[5px] glass-collaborate px-[30px] lg:px-[100px] py-[15px] rounded-xl text-white text-[15px] lg:text-[20px] xl:text-[25px] hover:animate-pulse">
                <h1>Collaborate?</h1>
